...
// hieght for text-one-sec-intro 
// page intro image resize
$(window).on('resize', function () {

    $(".text-one-sec-intro").height($(window).height());
    $(".text-one-sec-intro").width($(window).width());

});
//main slider height
$(".text-one-sec-intro").height($(window).height() - $("header").height());
